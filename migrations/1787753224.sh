...
# The Broadcom firmware on Apple Silicon Macs (BCM4378/BCM4387/BCM4388) can wedge
# across s2idle, leaving Wi-Fi able to scan but rejecting every association
# until the driver is reloaded (#197, #10857, upstream AsahiLinux/linux#439). Fresh
...
lspci -nn | grep -E "14e4:(4425|4433|4434)" >/dev/null || exit 0
