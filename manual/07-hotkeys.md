...
| `Super + Ctrl + Shift + Arrows` | Move window to directional monitor |
...
| Hotkey                  | Function              |
| ----------------------- | --------------------- |
| `Shift + Brightness Up` | Maximum screen brightness (keyboard backlight on Apple keyboards) |
| `Shift + Brightness Down` | Minimum screen brightness (keyboard backlight on Apple keyboards) |
...
With screenrecordings, the hotkey first asks which audio you want, then starts recording. Hit it again to stop. On an Apple keyboard, `Super + Ctrl + C` opens Capture (there is no Print Screen). See [screenshots and recording](12-screenshots-recording.md) for the details.
